...
export class Tunnel {
  ...
  /**
   * \brief Remove empty cells from the start (tail side) of the tunnel path.
   *
  ...
  /**
   * \brief Remove empty cells from the end (head side) of the tunnel path.
   *
  ...
  /**
   * \brief Trim empty cells from both ends of the tunnel path.
   *
  ...
  /**
   * \brief Reconstruct a path of head positions from a search node back to the root.
   *
   ...
   * \return An array of Points representing head positions from goal to start
   */
